...
function TeamMember() {
    ...
    const TEAM_MEMBER = [
        { id: 1, image: require('../assets/TMfirstProfile.jpg'), name: "Bablu", work: "Manager & web developer" },
        { id: 2, image: require('../assets/TMfirstProfile.jpg'), name: "Gaurav Negi", work: "Sr Web developer" },
        { id: 3, image: require('../assets/TMfirstProfile.jpg'), name: "Gaurav Bhatt", work: "Sr Web developer" },
        { id: 4, image: require('../assets/TMfirstProfile.jpg'), name: "Rakesh", work: "Web developer" },
        { id: 5, image: require('../assets/TMfirstProfile.jpg'), name: "Jaswant", work: "Web developer" }
    ];

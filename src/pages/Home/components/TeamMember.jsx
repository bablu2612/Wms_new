    ...
    <div className="mainTeamMember_class">
      <div className="ourPricing">
        ...
        <div className="specific_class">
          <p>
            Appropriate for our specific business, makingit easy for <br /> you
      ...
      <div className="teamMember">
        <div className="teamMember_title">
          <h3>
            <span></span>Team Member<span></span>
          </h3>
          <h2>
            Our Awesome <strong>Technology</strong>
            <br /> Team Member
          </h2>
        </div>
        <div className="card">
                ...
                <div className="item--holder-hover bg-image">
                  <div className="item--holder-inner">
                    ...
                    <a
                      ...
                      href="https://demo.casethemes.net/itfirm/team-details/"
                    >
                      Read More<i className="ct-icon-plus size-sm"></i>
                    </a>
                  </div>
                </div>
              </div>

    ...
    return (
        <div className="main_footer_section">
            <div className="footer_first_row">
                <img src={require('../../assets/wisemindSection.png')} alt="image" />
            ...
            <div className="footer_second_row">
                ...
                <div className="field_section">
                    <input type="text" placeholder="Your mail address" /><button>icon</button>
                </div>
                <div className="socialMediaIcons"></div>
            </div>
            <div className="footer_Third_row">
                <h3 className="blue_underline">Official info</h3>
                <div className="location"><span>icon</span><span>lorem ipsum india</span></div>
                <div className="mobile"><span>icon</span><span>1-888-452-1505</span></div>
